...
export function PricingPage() {
  return (
    <section className="desk-page pricing-page">
      ...
      <div className="pricing-callout"><div><strong>报价说明</strong><p>下表不包含视频输入费用。模型能力、可用清晰度、声音能力和最终结算以当前接口返回及客服确认为准。</p><p>联系邮箱：<a href="mailto:chenmomo3253@gmail.com">chenmomo3253@gmail.com</a></p></div><img src={contactQr} alt="CanvDoAI 官方微信二维码" /></div>
